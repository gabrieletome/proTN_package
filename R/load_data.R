...
read_proteomics <- function(software, folder, annotation_filename = "annotation",
  ...
  proteome_data = NULL
  if(software == "PD"){
    proteome_data = read_PD_files(anno_filename, pep_filename, prot_filename, batch_corr_exe= batch_corr_exe, filt_absent_value = filt_absent_value)
  } else if(software == "MQ"){
    proteome_data = read_MQ_files(anno_filename, pep_filename, batch_corr_exe = batch_corr_exe, filt_absent_value = filt_absent_value)
  }
