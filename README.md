...
ProTN is an R package that provides an integrated pipeline for the complete downstream analysis of proteomics, phospho-proteomics, and interactomics data following peptide quantification. It is compatible with MS-based proteomic experiments processed using Proteome Discoverer and MaxQuant, two of the most widely used platforms for extracting peptide abundances from raw MS spectra. For proteome and interactomics analyses, ProTN also supports input files generated by FragPipe and Spectronaut.
